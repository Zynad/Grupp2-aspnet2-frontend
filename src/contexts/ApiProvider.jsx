...
const getAllPromocodes = async ()=>{
    ...
    return (
        <>
            <ApiContext.Provider value={{ getAllProductsAsync, getProductByIdAsync, registrationAsync, loginAsync, logoutAsync, getProfile, recoverPassword, getAddress, registerAddress, removeAddress, updateAddress, loginFacebook, registerCreditCard, getUserCreditCards, removeCreditCard, getProductsByCategory, getProductsByFilters, verifyPhoneNumber, getAllCurrentPromocodes, getAllUsedPromocodes, addPromocodeVoucher, getAllPromocodes }}>
                {props.children}
            </ApiContext.Provider>
        </>
    )
